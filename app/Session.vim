...
silent only
cd ~/blog.buttlies.de/app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 views/blog/index.html.slim
badd +1 controllers/blog_controller.rb
badd +1 ../lib/post.rb
badd +28 ../config/application.rb
badd +1 ../posts/test.md
badd +1 assets/stylesheets/blog.css.sass
badd +1 ../config/routes.rb
args views/blog/index.html.slim
edit views/blog/index.html.slim
...
9
normal! 036l
tabedit assets/stylesheets/blog.css.sass
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
7
normal! 021l
tabedit controllers/blog_controller.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
